...
public class ReleaseMovieAlarm extends BroadcastReceiver {
    ...
    private static PendingIntent getPendingIntent(Context context) {
        Intent intent = new Intent(context, ReleaseMovieAlarm.class);
...
//            intent.putExtra("moviedate", movie.getReleaseDate());
            ...
            Log.d("data","data masuk : " +mMovieResults.size());
        ...
        Toast.makeText(context, R.string.daily_release_on, Toast.LENGTH_SHORT).show();
    }
    ...
    public void cancelAlarm(Context context) {
        ...
        Toast.makeText(context, R.string.daily_release_off, Toast.LENGTH_SHORT).show();
    }
