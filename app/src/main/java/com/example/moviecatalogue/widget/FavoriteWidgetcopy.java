 ...
 */
public class FavoriteWidgetcopy extends AppWidgetProvider {
...
//        appWidgetManager.updateAppWidget(appWidgetId, views);
        ...
        Intent toastIntent = new Intent(context, FavoriteWidgetcopy.class);
        toastIntent.setAction(FavoriteWidgetcopy.TOAST_ACTION);
