...
import com.example.moviecatalogue.helper.DatabaseContract;
import com.example.moviecatalogue.helper.MovieHelper;

import static com.example.moviecatalogue.helper.DatabaseContract.AUTHORITY;
...
public class MovieProvider extends ContentProvider {
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, DatabaseContract.TABLE_NAME, MOVIE);

        URI_MATCHER.addURI(AUTHORITY, DatabaseContract.TABLE_NAME+"/#",MOVIE_ID);
