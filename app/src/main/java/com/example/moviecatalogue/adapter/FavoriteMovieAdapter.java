...
public class FavoriteMovieAdapter extends RecyclerView.Adapter<FavoriteMovieAdapter.ViewHolder> {
    ...
    private List<FavoriteMovieModel> movieData = new ArrayList<>();
    ...
    public void setMovieData(List<FavoriteMovieModel> movies) {
        movieData.clear();
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final FavoriteMovieModel movieModel = movieData.get(position);
    ...
    public interface OnItemClickCallback {
        void onItemClicked(FavoriteMovieModel movieModel);
    }
}
